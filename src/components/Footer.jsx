...
const Footer = () => {
  ...
  return (
    <footer className='text-center space-y-4 pb-20 pt-10 bg-[#0050A5]'>
    <h3 className='text-3xl xs:text-2xl ss:text-2xl font-bold text-white pb-6'>DEVOLIX</h3>
    ...
    &copy;Copyright {new Date().getFullYear()}. All Rights Reserved DEVOLIX
  </p>
  <div>
